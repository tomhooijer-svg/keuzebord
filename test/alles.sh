...
R=$(cd "$(dirname "$0")/.." && pwd)
LIJST=${*:-"inloggen sync rollen toegang keten fotos pictos volgorde beheerder accounts losgeraakt doelen browsers werkmomenten statistiek verslag themas aanuit dubbel plaatshouder uiterste onderweg verdwenen naarhetbord opslagstand leerkracht tabbladen gesplitst knoppen doorloop"}
mis=0
